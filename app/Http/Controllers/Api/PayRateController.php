...
{
    /**
     * Get all rates for a pay group
     * GET /api/pay-groups/{groupId}/rates
     */
    public function index(Request $request, $groupId)
    {
        $rates = PayRate::where('pay_group_id', $groupId)->get();
        return response()->json($rates, 200);
    }

    /**
     * Create a new rate for a pay group
     * POST /api/pay-groups/{groupId}/rates
     */
    ...
    /**
     * Get a specific rate
     * GET /api/pay-rates/{rateId}
     */
    public function show($rateId)
    {
        $rate = PayRate::find($rateId);
